...
//  *** Significant Gardens Markers start ***  //
    ...
    let chdnGardensObj = {linkId: chdnGardensLink, linkName: 'CHDN Edible Gardens', linkDesc: "Description goes here"};
    // create dom listener for b-coloumn anchor link
    google.maps.event.addDomListener(chdnGardensLink, 'click', function() {
        map.setZoom(19);
        map.setCenter(chdnGardensMarker.getPosition());
        modifyTextBox(0, chdnGardensObj.linkName, chdnGardensObj.linkDesc);
    });
    ...
    chdnGardensMarker.addListener('mouseover', function() {
        modifyPinLabel(0, "Significant Gardens", chdnGardensObj.linkName);
        $("#POITextBox").hide();
    });
    // Click Listener for Pin Labels
    ...
    // create object to store Info Box attributes
    let japaneseGardenObj = {linkId: japaneseGardenLink, linkName: 'CAMP Japanese Garden', linkDesc: "Description goes here"};
    // create dom listener for b-coloumn anchor link
    ...
    // create object to store Info Box attributes
    let broadwayGardensObj = {linkId: broadwayGardensLink, linkName: 'Broadway Edible Gardens', linkDesc: "Description goes here"};
    // create dom listener for b-coloumn anchor link
    google.maps.event.addDomListener(broadwayGardensLink, 'click', function() {
        map.setZoom(19);
        map.setCenter(broadwayGardensMarker.getPosition());
        modifyTextBox(0, broadwayGardensObj.linkName, broadwayGardensObj.linkDesc);
    });
    // create click listener for marker
    ...
    broadwayGardensMarker.addListener('mouseover', function() {
        modifyPinLabel(0, "Significant Gardens", broadwayGardensObj.linkName);
        $("#POITextBox").hide();
    });
    // Click Listener for Pin Labels
    ...
    // create object to store Info Box attributes
    let ciscoeMorrisObj = {linkId: ciscoeMorrisLink, linkName: 'Cisco Morris Biodiversity Garden', linkDesc: "Description goes here"};
    // create dom listener for b-coloumn anchor link
...
//  ***  Union Green  ***  //
    ...
    // create object to store Info Box attributes
    let unionGreenObj = {linkId: unionGreenLink, linkName: 'Union Green', linkDesc: "Description goes here"};
    // create dom listener for b-coloumn anchor link
...
//  ***  Wildlife Garden  ***  //
    ...
    // create object to store Info Box attributes
    let wildlifeGardenObj = {linkId: wildlifeGardenLink, linkName: 'Wildlife Garden', linkDesc: "Description goes here"};
    // create dom listener for b-coloumn anchor link
...
//  ***  HUNT Meditation Garden  ***  //
    ...
    // create object to store Info Box attributes
    let meditationGardenObj = {linkId: meditationGardenLink, linkName: 'HUNT Meditation Garden', linkDesc: "Description goes here"};
    // create dom listener for b-coloumn anchor link
...
//  ***  Japanese Remembrance Gardens  ***  //
    ...
    // create object to store Info Box attributes
    let remembranceGardensObj = {linkId: remembranceGardensLink, linkName: 'Japanese Remembrance Gardens', linkDesc: "Description goes here"};
    // create dom listener for b-coloumn anchor link
...
//  ***  XAVR Courtyard Kubota Garden  ***  //
    ...
    // create object to store Info Box attributes
    let xavrGardenObj = {linkId: xavrGardenLink, linkName: 'XAVR Courtyard Kubota Garden', linkDesc: "Description goes here"};
    // create dom listener for b-coloumn anchor link
...
//  *** Notable Trees Markers start ***  //
    ...
    // create object to store Info Box attributes
    let marionRedwoodObj = {linkId: marionRedwoodLink, linkName: 'Marion Giant Redwood', linkDesc: "Description goes here"};
    // create dom listener for b-coloumn anchor link
    ...
    // create object to store Info Box attributes
    let garrLaurelObj = {linkId: garrLaurelLink, linkName: 'GARR Large Mature Laurel', linkDesc: "Description goes here"};
    // create dom listener for b-coloumn anchor link
    ...
    // create object to store Info Box attributes
    let kubotaMaplesObj = {linkId: kubotaMaplesLink, linkName: 'Kubota Mature Japanese Maples', linkDesc: "Description goes here"};
    // create dom listener for b-coloumn anchor link
